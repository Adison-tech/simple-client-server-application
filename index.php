...
<!--Fetch the Records --> 
                    <tr> 
                        ...
                        <td> 
  <a href="read.php?viewid=<?php echo htmlentities ($row['ID']);?>" class="view" title="View" data
...
data-toggle="tooltip" onclick="return confirm('Do you really want to Delete ?');"><i class="material
icons">&#xE872;</i></a> 
                        </td> 
                    </tr> 
                    <?php  
